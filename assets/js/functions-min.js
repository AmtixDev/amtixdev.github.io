...
console.log("Please refrain from using the developer console.");
var styles = 'font-weight: bold; color: red; font-size: 100px;';
var styles2 = 'font-weight: bold; color: red; font-size: 15px;';
var styles3 = 'font-weight: bold; color: red; font-size: 10px;';
var styles4 = 'font-weight: bold; color: yellow; font-size: 10px;';

function sendWarningMessage1() {
    console.log('%cWarning:', styles);
}

function sendWarningMessage2() {
    console.log('%cUnauthorized access detected!', styles2);
}

function sendWarningMessage3() {
    console.log('%cAn IP address would be displayed to website developer.', styles3);
}

function sendWarningMessage4() {
    console.log('%cDone, Sended to AmtiXDev.', styles4);
}

setTimeout(sendWarningMessage1, 10000);
setTimeout(sendWarningMessage2, 10000);
setTimeout(sendWarningMessage3, 20000);
setTimeout(sendWarningMessage4, 25000);
